...
import { fetchIntoStoreVehicleDetail, selectVehicleDetail } from "@/store/vehicle-data/reducer"
  ...
  return (
    <>
      ...
      <ScrollView className="flex-1 mb-28">
        ...
        <Features />
        {vehicleDetail?.description && <Description content={vehicleDetail?.description} />}
        <OwnerView
