...
interface SeatHeatedIconProps extends SvgProps {
  size?: number;
  color?: string;
}

const SeatHeatedIcon: React.FC<SeatHeatedIconProps> = ({
  size = 24,
  color = "#e3e3e3",
  ...props
}) => {
